...
const plans = new Map<string, RehabilitationPlan>();
...
export const fetchRehabilitationPlans = async (userId: string): Promise<RehabilitationPlan[]> => {
  try {
...
export const addRehabilitationPlan = async (planData: Omit<RehabilitationPlan, 'id' | 'createdAt' | 'updatedAt'>): Promise<RehabilitationPlan> => {
  try {
...
export const updateRehabilitationPlan = async (planId: string, updates: Partial<Omit<RehabilitationPlan, 'id' | 'createdAt' | 'updatedAt'>>): Promise<RehabilitationPlan> => {
  try {
    await new Promise(resolve => setTimeout(resolve, 300));
...
export const deleteRehabilitationPlan = async (planId: string): Promise<void> => {
  try {
    await new Promise(resolve => setTimeout(resolve, 300));
