...
export class EncryptionService {
    ...
    static decrypt(encryptedData) {
        try {
            ...
            // 復号化
            const decrypted = CryptoJS.AES.decrypt({ ciphertext: ciphertext, salt: '' }, this.SECRET_KEY, {
                iv: iv,
                mode: CryptoJS.mode.CBC,
                padding: CryptoJS.pad.Pkcs7
            });
     ...
     * ファイルを暗号化して保存する
     */
    static async encryptAndSaveFile(data, filename) {
        try {
     ...
     */
    static async loadAndDecryptFile(file) {
...
EncryptionService.SECRET_KEY = 'jyushin-care-app-secret-key-2024';
EncryptionService.IV_SIZE = 16;
