...
1. **AIはコード・データ・出力を生成する前に必ず本PROJECT_SOUL.mdを確認し、指示・理念・ガイドラインを厳守すること。**
2. **413エラー（Request Entity Too Large）対策ガイドラインを毎回必ず確認し、データサイズチェック・警告・送信中止・圧縮・ループ防止などを徹底すること。**
3. 本ファイルの内容は全AI・開発者が毎回レビューし、遵守を義務とする。
